...
public class RunAfterSimAnalysisBene implements MATSimAppCommand {
	...
	public Integer call() throws Exception {
		...
		log.info("Writing emissions for parking search per link [g/m] to: {}", linkEmissionPerMOutputFile_parkingSearch);
...
//		matsimEventsReader.readFile(eventsFile);
	...
	private void createEmissionAnalysis(String linkEmissionPerMOutputFile, String linkEmissionOutputFile, String linkEmissionPerMOutputFile_parkingTotal, String linkEmissionOutputFile_parkingTotal, String linkEmissionPerMOutputFile_parkingSearch, String linkEmissionOutputFile_parkingSearch, Scenario scenario, EmissionsOnLinkHandler emissionsOnLinkEventHandler) throws IOException {
		...
		BufferedWriter absolutWriter_parkingTotal  = new BufferedWriter(new FileWriter(linkEmissionAnalysisFile_parkingTotal));
		BufferedWriter perMeterWriter_parkingTotal = new BufferedWriter(new FileWriter(linkEmissionPerMAnalysisFile_parkingTotal));

		BufferedWriter absolutWriter_parkingSearch  = new BufferedWriter(new FileWriter(linkEmissionAnalysisFile_parkingSearch));
		BufferedWriter perMeterWriter_parkingSearch = new BufferedWriter(new FileWriter(linkEmissionPerMAnalysisFile_parkingSearch));
